...
public class IceBricksSlabBlock extends AvatarModElements.ModElement {
	@ObjectHolder("avatar:ice_bricks_slab")
	public static final Block block = null;
	public IceBricksSlabBlock(AvatarModElements instance) {
		super(instance, 40);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("ice_bricks_slab");
		}
