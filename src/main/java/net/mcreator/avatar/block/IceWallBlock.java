...
public class IceWallBlock extends AvatarModElements.ModElement {
	@ObjectHolder("avatar:ice_wall")
	public static final Block block = null;
	public IceWallBlock(AvatarModElements instance) {
		super(instance, 10);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.ICE).sound(SoundType.GLASS).hardnessAndResistance(1f, 10f).setLightLevel(s -> 0)
					.slipperiness(0.89f).speedFactor(1.2f).notSolid().setOpaque((bs, br, bp) -> false));
