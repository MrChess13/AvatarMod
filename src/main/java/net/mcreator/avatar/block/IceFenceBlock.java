...
public class IceFenceBlock extends AvatarModElements.ModElement {
	@ObjectHolder("avatar:ice_fence")
	public static final Block block = null;
	public IceFenceBlock(AvatarModElements instance) {
		super(instance, 6);
	}
