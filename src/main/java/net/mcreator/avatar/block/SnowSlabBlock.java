...
public class SnowSlabBlock extends AvatarModElements.ModElement {
	@ObjectHolder("avatar:snow_slab")
	public static final Block block = null;
	public SnowSlabBlock(AvatarModElements instance) {
		super(instance, 2);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.SNOW).sound(SoundType.SNOW).hardnessAndResistance(1f, 10f).setLightLevel(s -> 0).notSolid()
