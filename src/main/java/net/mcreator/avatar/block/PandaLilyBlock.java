...
import net.mcreator.avatar.procedures.PanadaLilyGrowingConditionProcedure;
...
public class PandaLilyBlock extends AvatarModElements.ModElement {
	@ObjectHolder("avatar:panda_lily")
	public static final Block block = null;
	public PandaLilyBlock(AvatarModElements instance) {
		super(instance, 117);
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			feature = new DefaultFlowersFeature(BlockClusterFeatureConfig.field_236587_a_) {
				...
				public boolean generate(ISeedReader world, ChunkGenerator generator, Random random, BlockPos pos, BlockClusterFeatureConfig config) {
					...
					int y = pos.getY();
					int z = pos.getZ();
					if (!PanadaLilyGrowingConditionProcedure.executeProcedure(ImmutableMap.of("x", x, "y", y, "z", z, "world", world)))
						return false;
			...
			event.getRegistry().register(feature.setRegistryName("panda_lily"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("avatar:panda_lily"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public boolean isValidGround(BlockState state, IBlockReader worldIn, BlockPos pos) {
			...
			if (worldIn instanceof IWorld) {
				...
				int y = pos.getY() + 1;
				int z = pos.getZ();
				additionalCondition = PanadaLilyGrowingConditionProcedure.executeProcedure(ImmutableMap.of("x", x, "y", y, "z", z, "world", world));
			}
