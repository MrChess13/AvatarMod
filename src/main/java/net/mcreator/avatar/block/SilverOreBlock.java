...
public class SilverOreBlock extends AvatarModElements.ModElement {
	@ObjectHolder("avatar:silver_ore")
	public static final Block block = null;
	public SilverOreBlock(AvatarModElements instance) {
		super(instance, 49);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("avatar:silver_ore_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("avatar:silver_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
