...
public class IceBricksBlock extends AvatarModElements.ModElement {
	@ObjectHolder("avatar:ice_bricks")
	public static final Block block = null;
	public IceBricksBlock(AvatarModElements instance) {
		super(instance, 14);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ICE).sound(SoundType.GLASS).hardnessAndResistance(1f, 10f).setLightLevel(s -> 0).slipperiness(1f)
					.notSolid().setOpaque((bs, br, bp) -> false));
			setRegistryName("ice_bricks");
		}
