...
public class IceBricksFenceGateBlock extends AvatarModElements.ModElement {
	@ObjectHolder("avatar:ice_bricks_fence_gate")
	public static final Block block = null;
	public IceBricksFenceGateBlock(AvatarModElements instance) {
		super(instance, 43);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("ice_bricks_fence_gate");
		}
