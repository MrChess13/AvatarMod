...
public class PackedIceFenceGateBlock extends AvatarModElements.ModElement {
	@ObjectHolder("avatar:packed_ice_fence_gate")
	public static final Block block = null;
	public PackedIceFenceGateBlock(AvatarModElements instance) {
		super(instance, 19);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.PACKED_ICE).sound(SoundType.GLASS).hardnessAndResistance(1f, 10f).setLightLevel(s -> 0)
					.slipperiness(1f).notSolid().setOpaque((bs, br, bp) -> false));
			setRegistryName("packed_ice_fence_gate");
		}
