...
public class BlueIceFenceGateBlock extends AvatarModElements.ModElement {
	@ObjectHolder("avatar:blue_ice_fence_gate")
	public static final Block block = null;
	public BlueIceFenceGateBlock(AvatarModElements instance) {
		super(instance, 25);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("blue_ice_fence_gate");
		}
