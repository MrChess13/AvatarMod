...
public class IceBricksWallBlock extends AvatarModElements.ModElement {
	@ObjectHolder("avatar:ice_bricks_wall")
	public static final Block block = null;
	public IceBricksWallBlock(AvatarModElements instance) {
		super(instance, 44);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("ice_bricks_wall");
		}
