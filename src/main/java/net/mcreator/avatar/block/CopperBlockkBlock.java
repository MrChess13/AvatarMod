...
public class CopperBlockkBlock extends AvatarModElements.ModElement {
	@ObjectHolder("avatar:copper_blockk")
	public static final Block block = null;
	public CopperBlockkBlock(AvatarModElements instance) {
		super(instance, 51);
	}
