...
public class PackedIceFenceBlock extends AvatarModElements.ModElement {
	@ObjectHolder("avatar:packed_ice_fence")
	public static final Block block = null;
	public PackedIceFenceBlock(AvatarModElements instance) {
		super(instance, 18);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("packed_ice_fence");
		}
