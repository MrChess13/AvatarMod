...
public class BlueIceStarisBlock extends AvatarModElements.ModElement {
	@ObjectHolder("avatar:blue_ice_staris")
	public static final Block block = null;
	public BlueIceStarisBlock(AvatarModElements instance) {
		super(instance, 23);
	}
		...
		public CustomBlock() {
			super(() -> new Block(Block.Properties.create(Material.PACKED_ICE).sound(SoundType.GLASS).hardnessAndResistance(1f, 10f)
					...
					Block.Properties.create(Material.PACKED_ICE).sound(SoundType.GLASS).hardnessAndResistance(1f, 10f).setLightLevel(s -> 0)
							.slipperiness(1f));
			setRegistryName("blue_ice_staris");
		}
