...
public class IceBricks3Block extends AvatarModElements.ModElement {
	@ObjectHolder("avatar:ice_bricks_3")
	public static final Block block = null;
	public IceBricks3Block(AvatarModElements instance) {
		super(instance, 35);
	}
