...
public class CopperBlockBlock extends AvatarModElements.ModElement {
	@ObjectHolder("avatar:copper_block")
	public static final Block block = null;
	public CopperBlockBlock(AvatarModElements instance) {
		super(instance, 48);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("avatar:copper_block_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("copper_block"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("avatar:copper_block"), configuredFeature);
		}
	}
	@SubscribeEvent
