...
public class IceBricks2Block extends AvatarModElements.ModElement {
	@ObjectHolder("avatar:ice_bricks_2")
	public static final Block block = null;
	public IceBricks2Block(AvatarModElements instance) {
		super(instance, 34);
	}
