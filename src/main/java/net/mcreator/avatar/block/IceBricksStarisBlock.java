...
public class IceBricksStarisBlock extends AvatarModElements.ModElement {
	@ObjectHolder("avatar:ice_bricks_staris")
	public static final Block block = null;
	public IceBricksStarisBlock(AvatarModElements instance) {
		super(instance, 41);
	}
		...
		public CustomBlock() {
			super(() -> new Block(
					Block.Properties.create(Material.PACKED_ICE).sound(SoundType.GLASS).hardnessAndResistance(1f, 10f).setLightLevel(s -> 0))
							.getDefaultState(),
					Block.Properties.create(Material.PACKED_ICE).sound(SoundType.GLASS).hardnessAndResistance(1f, 10f).setLightLevel(s -> 0));
			setRegistryName("ice_bricks_staris");
		}
