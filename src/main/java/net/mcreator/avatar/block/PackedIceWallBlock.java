...
public class PackedIceWallBlock extends AvatarModElements.ModElement {
	@ObjectHolder("avatar:packed_ice_wall")
	public static final Block block = null;
	public PackedIceWallBlock(AvatarModElements instance) {
		super(instance, 20);
	}
