...
public class IceBricksFenceBlock extends AvatarModElements.ModElement {
	@ObjectHolder("avatar:ice_bricks_fence")
	public static final Block block = null;
	public IceBricksFenceBlock(AvatarModElements instance) {
		super(instance, 42);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("ice_bricks_fence");
		}
