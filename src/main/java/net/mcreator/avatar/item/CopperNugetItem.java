...
public class CopperNugetItem extends AvatarModElements.ModElement {
	@ObjectHolder("avatar:copper_nuget")
	public static final Item block = null;
	public CopperNugetItem(AvatarModElements instance) {
		super(instance, 56);
	}
