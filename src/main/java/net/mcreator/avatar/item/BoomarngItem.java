...
public class BoomarngItem extends AvatarModElements.ModElement {
	@ObjectHolder("avatar:boomarng")
	public static final Item block = null;
	public BoomarngItem(AvatarModElements instance) {
		super(instance, 105);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("boomarng"));
	}
	private static class ItemToolCustom extends Item {
		protected ItemToolCustom() {
			super(new Item.Properties().group(AvatarModTabItemGroup.tab).maxDamage(500));
		}
