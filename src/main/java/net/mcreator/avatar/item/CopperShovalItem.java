...
public class CopperShovalItem extends AvatarModElements.ModElement {
	@ObjectHolder("avatar:copper_shoval")
	public static final Item block = null;
	public CopperShovalItem(AvatarModElements instance) {
		super(instance, 61);
	}
