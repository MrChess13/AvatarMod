...
public class CopperPickaxeItem extends AvatarModElements.ModElement {
	@ObjectHolder("avatar:copper_pickaxe")
	public static final Item block = null;
	public CopperPickaxeItem(AvatarModElements instance) {
		super(instance, 59);
	}
